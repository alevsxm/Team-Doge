...
describe Education do
  let(:alex_educations) { Education.create_educations(response_hash) }
  it 'has the right number of educations' do
    expect(alex_educations.length).to eq(1)
  end
  it 'has the school name' do
    expect(alex_educations[0].school_name).to eq("Colgate University")
  end
  it 'has the field of study' do
    expect(alex_educations[0].field_of_study).to eq("Economics")
  end
end
