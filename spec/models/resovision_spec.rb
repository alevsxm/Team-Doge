...
describe Resovision do
  let(:alex_resovision) { Resovision.create_resovision(response_hash) }
  it 'has a first name' do
    expect(alex_resovision.first_name).to eq('Alex')
  end
  it 'has a last name' do
    expect(alex_resovision.last_name).to eq('Levine')
  end
  it 'has a picture' do
    expect(alex_resovision.pic_url).to eq('http://m.c.lnkd.licdn.com/mpr/mprx/0_1C0R3cD1Wgq19WcUPTOk3vj0dY8yq7cUA5Ik3Nah94NuIIhRxkfc7qsaFPh_Be9B-TjLa1rDDqpa')
  end
end
